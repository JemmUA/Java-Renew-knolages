package codeBro.javaCore.serialization.serializer;
...
public class Serializer {
    ...
    public static void main(String[] args) throws IOException {
        ...
        User user = new User("Olexa", "password");
        user.sayHello();

        FileOutputStream fileOut = new FileOutputStream("src/main/java/codeBro/javaCore/serialization/userInfo1.ser");
